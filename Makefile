...
PRE_UNINSTALL = :
POST_UNINSTALL = :
build_triplet = arm-apple-darwin25.2.0
host_triplet = arm-apple-darwin25.2.0
subdir = .
...
ACLOCAL = ${SHELL} '/Users/barryjzhao/Sources/ffmpeg-build-mac/ffmpeg_sources/lame/missing' aclocal-1.18
ALLOCA = 
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AUTOCONF = ${SHELL} '/Users/barryjzhao/Sources/ffmpeg-build-mac/ffmpeg_sources/lame/missing' autoconf
AUTOHEADER = ${SHELL} '/Users/barryjzhao/Sources/ffmpeg-build-mac/ffmpeg_sources/lame/missing' autoheader
AUTOMAKE = ${SHELL} '/Users/barryjzhao/Sources/ffmpeg-build-mac/ffmpeg_sources/lame/missing' automake-1.18
AWK = awk
CC = gcc
...
FILECMD = file
FRONTEND_CFLAGS =  
FRONTEND_LDADD = -lncurses -L/opt/homebrew/Cellar/mpg123/1.33.3/lib -lmpg123   -lm
FRONTEND_LDFLAGS =  -static
GREP = /usr/bin/grep
GTK_CFLAGS = 
GTK_CONFIG = no
GTK_LIBS = 
INCLUDES = -I/opt/homebrew/Cellar/mpg123/1.33.3/include -I$(top_srcdir)/include -I$(srcdir)
...
LDADD = 
LDFLAGS = 
LIBMP3LAME_LDADD = -L/opt/homebrew/Cellar/mpg123/1.33.3/lib -lmpg123 
LIBOBJS = 
LIBS = 
...
MAINT = #
MAKEDEP = -make
MAKEINFO = ${SHELL} '/Users/barryjzhao/Sources/ffmpeg-build-mac/ffmpeg_sources/lame/missing' makeinfo
MANIFEST_TOOL = :
MKDIR_P = mkdir -p
NASM = no
NASM_FORMAT = -f macho
...
WITH_MP3RTP = 
WITH_MP3X = 
abs_builddir = /Users/barryjzhao/Sources/ffmpeg-build-mac/ffmpeg_sources/lame
abs_srcdir = /Users/barryjzhao/Sources/ffmpeg-build-mac/ffmpeg_sources/lame
abs_top_builddir = /Users/barryjzhao/Sources/ffmpeg-build-mac/ffmpeg_sources/lame
abs_top_srcdir = /Users/barryjzhao/Sources/ffmpeg-build-mac/ffmpeg_sources/lame
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /Users/barryjzhao/Sources/ffmpeg-build-mac/ffmpeg_sources/lame/install-sh
...
mkdir_p = $(MKDIR_P)
mpg123_CFLAGS = -I/opt/homebrew/Cellar/mpg123/1.33.3/include
mpg123_LIBS = -L/opt/homebrew/Cellar/mpg123/1.33.3/lib -lmpg123
